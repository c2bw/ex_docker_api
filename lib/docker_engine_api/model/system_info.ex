...
defmodule DockerEngineAPI.Model.SystemInfo do
  ...
  @type t :: %__MODULE__{
    ...
    :FirewallBackend => DockerEngineAPI.Model.FirewallInfo.t | nil,
    :DiscoveredDevices => [DockerEngineAPI.Model.DeviceInfo.t] | nil,
    :NRI => DockerEngineAPI.Model.NriInfo.t | nil,
    :Warnings => [String.t] | nil,
    :CDISpecDirs => [String.t] | nil,
    :Containerd => DockerEngineAPI.Model.ContainerdInfo.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:FirewallBackend, :struct, DockerEngineAPI.Model.FirewallInfo)
     |> Deserializer.deserialize(:DiscoveredDevices, :list, DockerEngineAPI.Model.DeviceInfo)
     |> Deserializer.deserialize(:NRI, :struct, DockerEngineAPI.Model.NriInfo)
     |> Deserializer.deserialize(:Containerd, :struct, DockerEngineAPI.Model.ContainerdInfo)
  end
end
