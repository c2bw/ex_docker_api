...
defmodule DockerEngineAPI.Connection do
  ...
  @default_base_url "http://localhost/v1.55"
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ex_docker_api, :base_url, @default_base_url)
      )
    ...
    timeout =
      Keyword.get(
        options,
        :timeout,
        Application.get_env(:ex_docker_api, :timeout, @default_timeout)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ex_docker_api 1.55 - elixir"
        )
      )
