...
defmodule DockerEngineAPI.Api.Network do
  ...
  - `{:ok, DockerEngineAPI.Model.NetworkInspect.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec network_inspect(Tesla.Env.client, String.t, keyword()) :: {:ok, DockerEngineAPI.Model.NetworkInspect.t} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def network_inspect(connection, id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, DockerEngineAPI.Model.NetworkInspect},
      {404, DockerEngineAPI.Model.ErrorResponse},
      {500, DockerEngineAPI.Model.ErrorResponse}
    ])
  end
  ...
  - `{:ok, [%NetworkSummary{}, ...]}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec network_list(Tesla.Env.client, keyword()) :: {:ok, [DockerEngineAPI.Model.NetworkSummary.t]} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def network_list(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, DockerEngineAPI.Model.NetworkSummary},
      {500, DockerEngineAPI.Model.ErrorResponse}
    ])
  end
