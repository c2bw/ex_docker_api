...
defmodule DockerEngineAPI.Api.Volume do
  ...
  - `volume_config` (VolumeCreateRequest): Volume configuration
  ...
  """
  @spec volume_create(Tesla.Env.client, DockerEngineAPI.Model.VolumeCreateRequest.t, keyword()) :: {:ok, DockerEngineAPI.Model.Volume.t} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
