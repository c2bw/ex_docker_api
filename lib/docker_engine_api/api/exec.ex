...
defmodule DockerEngineAPI.Api.Exec do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec exec_resize(Tesla.Env.client, String.t, integer(), integer(), keyword()) :: {:ok, nil} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def exec_resize(connection, id, h, w, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/exec/#{id}/resize")
