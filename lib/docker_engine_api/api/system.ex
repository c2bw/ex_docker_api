...
defmodule DockerEngineAPI.Api.System do
  ...
  - `{:ok, DockerEngineAPI.Model.AuthResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec system_auth(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, DockerEngineAPI.Model.AuthResponse.t} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def system_auth(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, DockerEngineAPI.Model.AuthResponse},
      {204, false},
