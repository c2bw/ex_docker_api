...
defmodule DockerEngineAPI.Api.Plugin do
  ...
  """
  @spec get_plugin_privileges(Tesla.Env.client, String.t, keyword()) :: {:ok, [DockerEngineAPI.Model.PluginPrivilege.t]} | {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec plugin_list(Tesla.Env.client, keyword()) :: {:ok, DockerEngineAPI.Model.ErrorResponse.t} | {:ok, [DockerEngineAPI.Model.Plugin.t]} | {:error, Tesla.Env.t}
